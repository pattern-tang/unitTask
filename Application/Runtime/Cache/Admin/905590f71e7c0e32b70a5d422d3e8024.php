...
<script>
    var listUrl='<?php echo U("Admin/Role/checkAccess");?>';
        ...
        if(purview('delete')){
            if(id!=null){
                if(confirm("你确定是要删除name为"+name+"的记录吗？")) {
                    window.location.href = "<?php echo U('Admin/Role/runDelete/id/" + id + "');?>";
                }
            }
                ...
                window.location.href = "<?php echo U('Admin/Role/runDelete/id/" + flag + "');?>";
            }
        }
    }
    function add() {
        window.location.href="<?php echo U('Admin/Role/showAdd');?>";
    }
    function update(id) {
        if(purview('update')) {
            window.location.href = "<?php echo U('Admin/Role/showUpdate/id/" + id + "');?>";
        }
    }
</script>
