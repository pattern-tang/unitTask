...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('School/User/adminRole');?>" data-title="角色管理" href="javascript:void(0)">admin-role角色管理</a></li>
					<li><a data-href="<?php echo U('School/User/adminPermission');?>" data-title="权限管理" href="javascript:void(0)">admin-permission权限管理</a></li>
					<li><a data-href="<?php echo U('School/User/adminList');?>" data-title="管理员列表" href="javascript:void(0)">admin-list管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('');?>" data-title="折线图" href="javascript:void(0)">折线图</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="时间轴折线图" href="javascript:void(0)">时间轴折线图</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="区域图" href="javascript:void(0)">区域图</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="柱状图" href="javascript:void(0)">柱状图</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="饼状图" href="javascript:void(0)">饼状图</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="3D柱状图" href="javascript:void(0)">3D柱状图</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="3D饼状图" href="javascript:void(0)">3D饼状图</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('');?>" data-title="系统设置" href="javascript:void(0)">system-base系统设置</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="栏目管理" href="javascript:void(0)">system-category栏目管理</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="数据字典" href="javascript:void(0)">system-data数据字典</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="屏蔽词" href="javascript:void(0)">system-shieldin屏蔽词</a></li>
					<li><a data-href="<?php echo U('');?>" data-title="系统日志" href="javascript:void(0)">system-log系统日志</a></li>
				</ul>
			</dd>
		</dl>
	</div>
