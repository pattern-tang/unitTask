...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l"><a href="javascript:;" onclick="article_del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
			<a class="btn btn-primary radius" data-title="添加试卷" data-href="<?php echo U('School/Add/articleAdd');?>" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加试卷</a>
		</span>
	...
	<div class="mt-20">
		...
		<tr class="text-c">
					...
					<th>试卷名</th>
					<th>单元(知识点)</th>
					<th width="110">监考教师</th>
					<th width="80">试卷分类年级</th>
					<th width="80">试卷分类班级</th>
					<th width="80">试卷分类科目</th>
			<th width="100">时间</th>
			<th width="60">分数</th>
					<th width="120">操作</th>
				</tr>
